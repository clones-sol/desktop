import 'package:clones/application/agent.dart';
import 'package:clones/assets.dart';
import 'package:clones/domain/models/agent/agent_deployment.dart';
import 'package:clones/domain/models/agent/agent_legal.dart';
import 'package:clones/domain/models/agent/agent_tokenomics.dart';
import 'package:clones/domain/models/agent/deployment_version.dart';
...
import 'package:clones/ui/components/responsive_two_column_layout.dart';
...
class ForgeGymDeployTab extends ConsumerWidget {
...
class _AgentPreviewCard extends StatelessWidget {
  ...
  factory _AgentPreviewCard.fromAgent(GymAgent agent) {
