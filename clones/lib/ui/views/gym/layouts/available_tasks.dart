...
import 'package:clones/domain/models/ui/gym_filter.dart';
import 'package:clones/ui/views/gym/layouts/components/filter_panel.dart';
import 'package:clones/ui/views/gym/layouts/components/task_card.dart';
          ...
          if (_showFilters)
            FilterPanel(
              ...
              onResetFilters: () {
                ...
                ref.read(gymSettingsNotifierProvider.notifier).saveGymSettings(
                      const GymSettings(),
                    );
                _applyFilters();
              },
