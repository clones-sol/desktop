...
abstract class $AppInfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String type, String url, String? taskId});
}
...
class _$AppInfoImpl implements _AppInfo {
  const _$AppInfoImpl(
      {required this.name, required this.type, required this.url, this.taskId});
  ...
  @override
  String toString() {
    return 'AppInfo(name: $name, type: $type, url: $url, taskId: $taskId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, name, type, url, taskId);
...
abstract class _AppInfo implements AppInfo {
  const factory _AppInfo(
      ...
      final String? taskId}) = _$AppInfoImpl;
