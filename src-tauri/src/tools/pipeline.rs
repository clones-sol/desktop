...
fn get_pipeline_url() -> String {
    std::env::var("PIPELINE_URL_WIN").unwrap_or_else(|_| "https://github.com/viralmind-ai/vm-pipeline/releases/latest/download/pipeline-win-x64.exe".to_string())
}

#[cfg(target_os = "linux")]
fn get_pipeline_url() -> String {
    std::env::var("PIPELINE_URL_LINUX").unwrap_or_else(|_| "https://github.com/viralmind-ai/vm-pipeline/releases/latest/download/pipeline-linux-x64".to_string())
}

#[cfg(target_os = "macos")]
fn get_pipeline_url() -> String {
    std::env::var("PIPELINE_URL_MACOS").unwrap_or_else(|_| "https://github.com/viralmind-ai/vm-pipeline/releases/latest/download/pipeline-macos-arm64".to_string())
}
