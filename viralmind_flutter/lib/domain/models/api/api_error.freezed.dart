...
abstract class $ApiErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call({int status, String statusText, String message, dynamic data});
}
...
class _$ApiErrorImpl implements _ApiError {
  ...
  @override
  String toString() {
    return 'ApiError(status: $status, statusText: $statusText, message: $message, data: $data)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, status, statusText, message,
