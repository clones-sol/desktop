...
abstract class $TokenBalanceCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, double balance});
}
...
class _$TokenBalanceImpl implements _TokenBalance {
  const _$TokenBalanceImpl({required this.token, required this.balance});
  ...
  @override
  String toString() {
    return 'TokenBalance(token: $token, balance: $balance)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, token, balance);
...
abstract class _TokenBalance implements TokenBalance {
  const factory _TokenBalance(
      ...
      required final double balance}) = _$TokenBalanceImpl;
