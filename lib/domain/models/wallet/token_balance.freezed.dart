...
class _$TokenBalanceImpl implements _TokenBalance {
  ...
  @override
  String toString() {
    return 'TokenBalance(symbol: $symbol, name: $name, logoUrl: $logoUrl, balance: $balance, isLoading: $isLoading)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, symbol, name, logoUrl, balance, isLoading);
...
abstract class _TokenBalance implements TokenBalance {
  const factory _TokenBalance(
      ...
      final double? balance,
      final bool isLoading}) = _$TokenBalanceImpl;
