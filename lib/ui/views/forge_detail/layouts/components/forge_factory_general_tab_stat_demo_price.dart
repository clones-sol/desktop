...
class ForgeFactoryGeneralTabStatDemoPrice extends ConsumerWidget {
  const ForgeFactoryGeneralTabStatDemoPrice({super.key});
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: ClonesColors.containerIcon1.withOpacity(0.2),
                    borderRadius: BorderRadius.circular(10),
                  ),
                  child: Icon(
                    Icons.card_giftcard,
                    color: ClonesColors.containerIcon1.withOpacity(0.7),
                    size: 20,
                  ),
                ),
                Container(
