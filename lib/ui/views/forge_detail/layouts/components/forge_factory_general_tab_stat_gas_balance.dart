...
class ForgeFactoryGeneralTabStatGasBalance extends ConsumerWidget {
  const ForgeFactoryGeneralTabStatGasBalance({super.key});
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            ClonesColors.containerIcon3.withOpacity(0.2),
                        borderRadius: BorderRadius.circular(10),
                      ),
                      child: Icon(
                        Icons.local_gas_station,
                        color:
                            ClonesColors.containerIcon3.withOpacity(0.7),
                        size: 20,
                      ),
                    ),
                  ],
